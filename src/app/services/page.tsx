    ...
    <div className="flex min-h-screen flex-col bg-[#faf8f5]">
      <header className="sticky top-0 z-10 flex items-center justify-between bg-[#faf8f5]/90 px-6 py-5 backdrop-blur-sm">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-light text-[#3d3530]">Services</h1>
        </div>
        <Link href="/services/new" className="rounded-full bg-[#c4a77d] px-5 py-3 text-sm font-medium text-white shadow-sm active:scale-[0.98]">+ Add</Link>
      </header>
      ...
      <main className="flex-1 px-6 py-4">
        {services.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="mb-2 text-lg font-medium text-[#3d3530]">No services yet</h2>
            <p className="mb-6 text-sm text-[#8b7355]">Add utilities like electricity, water...</p>
            <Link href="/services/new" className="rounded-full bg-[#c4a77d] px-6 py-3 text-sm font-medium text-white shadow-sm">Add Service</Link>
          </div>
        ) : (
