  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50">
      <header className="sticky top-0 z-10 flex items-center gap-3 bg-white px-4 py-4 shadow-sm">
        ...
        <h1 className="text-xl font-bold text-gray-800">Add Service</h1>
      </header>
      <main className="flex-1 p-4"><div className="rounded-2xl bg-white p-6 shadow-sm"><ServiceForm /></div></main>
    </div>
  );
}
